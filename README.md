...
<div align="center">
  ...
  <p align="center">
    ...
    <a href="#-arquitectura-del-sistema">
      <img src="https://img.shields.io/badge/🏗️_ARQUITECTURA-10B981?style=for-the-badge" />
    </a>
...
<p align="center">
  <img src="https://via.placeholder.com/800x400/6366F1/FFFFFF?text=Dashboard+Preview+-+Glassmorphism+UI" alt="Dashboard Preview" width="80%" style="border-radius: 20px; box-shadow: 0 20px 40px rgba(99,102,241,0.3);" />
</p>

<p align="center">
  <i>✨ Interfaz con diseño glassmorphism, gráficos interactivos y actualización en tiempo real</i>
  <br>
  <b>Frontend:</b> http://localhost:3000 | <b>Backend:</b> http://localhost:4000/api
</p>
...
Definición del star schema

Método de prorrateo de pagos

Comandos exactos de tus scripts

✅ Tu información personal:

Usuario de GitHub: EmersonRodas9029

Repositorio: datalysis-kpi-dashboard
